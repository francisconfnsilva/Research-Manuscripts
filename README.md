# Academic Research Portfolio & Selected Manuscripts

This repository contains selected manuscripts, theses, and poster presentations from my previous research experiences.

*Note: The codebases for some of these projects are currently kept private due to ongoing research embargos, pending publications, or data privacy agreements. Please feel free to reach out to discuss the mathematical and computational methodologies in detail.*

## Theses & Research Manuscripts

### 1. Beyond the Euclidean Map: A Reinforcement Learning Perspective on Hippocampal Representations
...
### 3. Hematological Diagnosis: Deep Learning for Bone Marrow Cell Classification
